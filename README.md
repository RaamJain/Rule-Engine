Backend: A python based backend applying a AST for rule-based engine utilising the flask framework and the flask-cors framework to connect both the frontend and the backend.
